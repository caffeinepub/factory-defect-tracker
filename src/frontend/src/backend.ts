...
import type { DefectReportView as _DefectReportView, ExternalBlob as _ExternalBlob, NewDefectReport as _NewDefectReport, Time as _Time, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async createDefectReport(arg0: NewDefectReport): Promise<bigint> {
        if (this.processError) {
            try {
                const result = await this.actor.createDefectReport(await to_candid_NewDefectReport_n8(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllReports(): Promise<Array<DefectReportView>> {
        if (this.processError) {
            try {
    ...
    async getReportsByDepartment(arg0: string): Promise<Array<DefectReportView>> {
        if (this.processError) {
            try {
    ...
    async getReportsByProduct(arg0: string): Promise<Array<DefectReportView>> {
        if (this.processError) {
            try {
                const result = await this.actor.getReportsByProduct(arg0);
                return from_candid_vec_n11(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_DefectReportView_n12(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _DefectReportView): Promise<DefectReportView> {
...
async function from_candid_vec_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_DefectReportView>): Promise<Array<DefectReportView>> {
    return await Promise.all(value.map(async (x)=>await from_candid_DefectReportView_n12(_uploadFile, _downloadFile, x)));
}
...
async function to_candid_NewDefectReport_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: NewDefectReport): Promise<_NewDefectReport> {
